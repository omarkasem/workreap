                ...
                <div class="col-sm-12">
                    <div class="wr-deactived-popup">
                        <div class="wr-alertpopup">
                            ...
                            <p><?php esc_html_e("Your account has been previously deactivated. Do you want to continue logging in and reactivate your account?","workreap");?></p>
                            <ul class="wr-btnareafull">
                                <li><span style="background-color: #1f62ff !important;
    color: #fff !important;" data-id="<?php echo intval($url_identity);?>" class="wr-pb wr-active-account wr-greenbtn"><?php esc_html_e('Reactivate Account','workreap');?></span></li>
								<li style="cursor:pointer;margin-top: 10px;"><span class="cancel-reactivation"><?php esc_html_e('Cancel','workreap');?></span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                ...
                                if ( !empty($app_task_base) && !empty($reference) && !empty($mode) && $reference === 'task' && $mode === 'listing' && $user_type === 'freelancers') {
                                    ...
                                    if (  !empty($mode) && $mode === 'detail'){
                                        ...
                                        <div class="wr-invoicehead">
                                            <span data-order_id="<?php echo intval($args['order_id']);?>" class="wr-download-pdf2 wr-btn"><i class="wr-icon-mail"></i><?php esc_html_e('Export PDF','workreap');?></span>
                                        </div>
                                        <?php
                                        if(!empty($user_type ) && $user_type === 'employers' ) {
                                        ...
                                        ?>
                                        <div class="wr-invoicehead">
                                            <span data-order_id="<?php echo intval($args['order_id']);?>" class="wr-download-pdf2 wr-btn"><i class="wr-icon-download"></i><?php esc_html_e('Export PDF','workreap');?></span>
                                        </div>
                                        <?php
                                        if(!empty($user_type ) && $user_type === 'employers' ) {
