        ...
        <div class="wr-asidebox wr-profile-area-wrapper" id="workreap-droparea">
            <div id="wr-asideprostatusv2" class="wr-asideprostatusv2">
                ...
                <div class="wr-profile-content-area">
                    ...
                    <p class="wr-profile-content-desc"><?php esc_html_e('Profile image should have jpg, jpeg, gif, png extension and size should not be more than '.$upload_file_size.'','workreap'); ?></p>
			...
			<fieldset>
				<div class="wr-profileform__holder">
					<div class="wr-profileform__detail wr-billinginfo">
						...
						<div style="display:none;" class="<?php echo esc_attr($country_class);?> form-group_vertical">
...
<!--OKEDIT-->
						<div style="display:none;" class="form-group-half form-group_vertical">
