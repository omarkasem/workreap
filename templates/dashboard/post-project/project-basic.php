...
$state_country_class	= !empty($enable_state) && empty($selected_country) ? 'd-none' : '';
if (class_exists('WooCommerce')) {
...
$work_start_date = get_post_meta($post_id, 'work_start_date', true);
$work_start_date = !empty($work_start_date) ? $work_start_date : date('Y-m-d');
?>
                ...
                <form class="wr-themeform wr-project-form" id="service-media-attachments-form">
                    <fieldset>
                        <div class="wr-themeform__wrap">
                            ...
                            <?php }?>
							<!-- OKEDIT -->
                            <div style="display:none;" class="form-group form-group-half <?php echo esc_attr($fixed_class);?>">
                                <label class="wr-label"><?php esc_html_e('Add minimum fixed budget','workreap');?></label>
                                <div class="wr-placeholderholder">
                                    <input value="1" type="text" name="min_price" value="<?php echo esc_attr($min_price);?>" class="form-control wr-themeinput" placeholder="<?php esc_attr_e('Enter min price','workreap');?>">
                                </div>
                            </div>
                            ...
                            <?php } ?>
                            <div style="display:none;" class="form-group form-group-half">
                            ...
                            <div class="form-group form-group-half">
                                <label class="wr-label"><?php esc_html_e('Work start date','workreap');?></label>
                                <div class="wr-select">
                                    <input  type="date" name="work_start_date" value="<?php echo esc_attr( $work_start_date ); ?>" min="<?php echo date( 'Y-m-d' ); ?>">
                                </div>
                            </div>
                            
                            <div class="form-group form-group_vertical">
                                <label class="form-group-title"><?php esc_html_e( 'Job Address', 'workreap' ); ?></label>
                                <input type="text" class="form-control google-autocomplete" id="full_address" name="full_address" placeholder="<?php esc_attr_e( 'Enter your full address', 'workreap' ); ?>" autocomplete="off" value="<?php echo esc_attr( $full_address ); ?>">
                            ...
                            <div style="display:none;" class="form-group form-group-half <?php echo esc_attr($location_class);?>">
...
$scripts	= "
    jQuery(document).ready(function($){
        ...
        // Set min_price to max_price value on page load
        jQuery( document ).ready( function() {
            var maxPrice = jQuery( 'input[name=\'max_price\']' ).val();
            jQuery( 'input[name=\'min_price\']' ).val( maxPrice - 1 );
        });
        
        jQuery( 'input[name=\'max_price\']' ).on( 'change', function() {
            var maxPrice = jQuery( this ).val();
            jQuery( 'input[name=\'min_price\']' ).val( maxPrice - 1 );
        });
    });";
