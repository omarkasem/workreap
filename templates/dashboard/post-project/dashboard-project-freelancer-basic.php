...
<?php if( !empty($proposal_status) && in_array($proposal_status,array('hired','cancelled')) ){?>
	<div class="comp_proj">
		<a class="wr-btn-solid wr_proposal_completed" data-proposal_id="<?php echo intval($proposal_id);?>" data-title="<?php echo esc_attr($project_title);?>" href="javascript:void(0)">Complete project</a>
	</div>
